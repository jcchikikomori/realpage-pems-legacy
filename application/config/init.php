...
/*
 * Time Zones Fix. To see all current timezones, @see http://php.net/manual/en/timezones.php
 */
...
define('HEADER', VIEWS_PATH . (isset($header) ? $header : '_header') . DIRECTORY_SEPARATOR);
define('FOOTER', VIEWS_PATH . (isset($footer) ? $footer : '_footer') . DIRECTORY_SEPARATOR);
define('TEMPLATES', VIEWS_PATH . (isset($templates) ? $templates : '_templates') . DIRECTORY_SEPARATOR);
...
define("EMAIL_SMTP_HOST", "ssl://smtp.gmail.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "email-ni-client@my.jru.edu");
define("EMAIL_SMTP_PASSWORD", "password-ni-client");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
...
define("EMAIL_PASSWORD_RESET_FROM", "no-reply@realpageadmin.com");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "Administrator");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for realpage MIS PROJECT");
...
define("EMAIL_VERIFICATION_FROM", "no-reply@realpageadmin.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Administrator");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for realpage MIS PROJECT");
...
define("EMAIL_OFFICIAL_SENDER", "realpage // MOBILIZER");
...
define("FEEDBACK_INVALID_LOGOUT", "You've been logged out before.");
// define("FEEDBACK_LOGGED_OUT", "You've been logout at " . date(DATE_CUSTOM) . ".");
define("FEEDBACK_LOGGED_OUT", "You've been logged out. ");
...
/** CRUD MESSAGES **/
define("CRUD_COMPLETE", "Process Complete.");
define("CRUD_ADDED", "Added.");
define("CRUD_UPDATED", "Updated.");
define("CRUD_DELETE", "Deleted.");

/** CRUD ERRORS **/
define("CRUD_MISSING", "WARNING! Some required fields are missing.");
...
define("CRUD_CONSTRAINT_ERROR", "Constraint Conflict Detected.");
...
if (isset($email)) { define("DEFAULT_RESPONSE_TEXT", "Hi! We hear your feedback we and appreciated it. But we need more detailed discussion by sending it to ".$email); }
define('DEFAULT_BG', URL . 'img/bg_default.jpg');
