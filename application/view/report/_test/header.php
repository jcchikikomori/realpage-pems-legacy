...
<head>
    ...
    <link href="<?php echo URL . ASSETS; ?>css/custom_v2.css" rel="stylesheet" media="all">
    <!-- TODO: custom font-size harcoded in custom.css -->
    <link href="<?php echo URL . BOWER; ?>bootstrap-table/dist/bootstrap-table.min.css" rel="stylesheet" media="all">
